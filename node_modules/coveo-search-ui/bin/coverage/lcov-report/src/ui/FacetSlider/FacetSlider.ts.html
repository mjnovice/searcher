...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">85.23% <small>(352 / 413)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">72.73% <small>(152 / 209)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75% <small>(57 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">84.79% <small>(329 / 388)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  private normalizeStartAndEndOptionsValues() {
    if (this.options.start) {
      this.options.start = this.options.dateField
        ...
        : &lt;any&gt;<span class="branch-1 cbranch-no" title="branch not covered" >Number(this.options.start);</span>
    }
&nbsp;
    if (this.options.end) {
  ...
  private bindResizeEvents() {
    this.onResize = debounce(() =&gt; {
      if (ResponsiveComponentsUtils.shouldDrawFacetSlider($$(this.root), $$(this.element)) &amp;&amp; this.slider &amp;&amp; !this.isEmpty) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.delayedGraphData) {
<span class="cstat-no" title="statement not covered" >          this.drawDelayedGraphData();</span>
        } else {
...
&nbsp;
    $$(this.root).on(InitializationEvents.nuke, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleNuke())</span>;
  }
&nbsp;
...
&nbsp;
    this.slider = this.slider
      ? <span class="branch-0 cbranch-no" title="branch not covered" >this.slider</span>
...
<span class="cstat-no" title="statement not covered" >    const values = args.slider.getValues();</span>
...
&nbsp;
  private isDropdownHidden() {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if ($$(this.root).hasClass('CoveoRecommendation')) {
<span class="cstat-no" title="statement not covered" >      const recommendationDropdown = $$(this.root).parents('.coveo-recommendation-column')[0] || this.root;</span>
...
&nbsp;
  private trySetSliderBoundaryFromQueryResult(data: IQuerySuccessEventArgs) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (groupByResults &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >groupByResults.values.length &gt; 0 </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >groupByResults.values[0].numberOfResults != 0)</span> {
