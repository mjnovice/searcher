...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">93.02% <small>(40 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Template, IFieldsToMatch, TemplateRole } from './Template';
...
&nbsp;
    this.template.addFields(TemplateConditionEvaluator.getFieldFromString(scriptTag.innerHTML + ' ' + condition) || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>;
&nbsp;
...
&nbsp;
  static fromString(
    template: string,
    <span class="missing-if-branch" title="if path not taken" >I</span>properties: ITemplateFromStringProperties = {},
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (properties.role != null) {
<span class="cstat-no" title="statement not covered" >      container.setAttribute('data-role', properties.role);</span>
    }
    return container;
  }
}
