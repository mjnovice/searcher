...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">97.59% <small>(162 / 166)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.33% <small>(35 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">94.74% <small>(36 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">97.35% <small>(147 / 151)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  private preventEventPropagationOn(
    eventType,
    <span class="missing-if-branch" title="else path not taken" >E</span>eventName = (event: string) =&gt; {
      return event;
    }
  ) {
