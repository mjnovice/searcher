...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResultList/ResultListRenderer.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResultList/ResultListRenderer.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResultList/</a> &#187; ResultListRenderer.ts</div>
</div>
<div class="body">
...
&nbsp;
  renderResults(
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>append = false,
