...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/FormWidgets/Dropdown.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/FormWidgets/Dropdown.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/FormWidgets/</a> &#187; Dropdown.ts</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
  constructor(
    public <span class="fstat-no" title="function not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>onChange: (dropdown: Dropdown) =&gt; void = (dropdown: Dropdown)</span> =&gt; {},
