...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/FormWidgets/MultiSelect.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/FormWidgets/MultiSelect.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/FormWidgets/</a> &#187; MultiSelect.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { IFormWidget, IFormWidgetSettable } from './FormWidgets';
...
&nbsp;
   ...
   */
  constructor(
    public <span class="fstat-no" title="function not covered" ><span class="missing-if-branch" title="if path not taken" >I</span>onChange: (multiSelect: MultiSelect) =&gt; void = (multiSelect: MultiSelect)</span> =&gt; {},
