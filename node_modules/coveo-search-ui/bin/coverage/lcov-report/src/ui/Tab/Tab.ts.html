...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">95.38% <small>(124 / 130)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">90.38% <small>(47 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_Tab';
...
&nbsp;
    new AccessibleButton()
      .withElement(element)
      .withSelectAction(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.select())</span>
