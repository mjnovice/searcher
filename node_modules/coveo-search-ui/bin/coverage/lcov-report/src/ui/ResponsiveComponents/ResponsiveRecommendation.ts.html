...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">85.81% <small>(133 / 155)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.54% <small>(24 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75.76% <small>(25 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">87.59% <small>(127 / 145)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    ResponsiveComponentsManager.register(</span>
...
<span class="branch-0 cbranch-no" title="branch not covered" >      case 'small':</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
<span class="branch-1 cbranch-no" title="branch not covered" >      case 'auto':</span>
<span class="cstat-no" title="statement not covered" >        return isWidthSmallerThanBreakpoint;</span>
      default:
        return false;
    }
  }
...
<span class="cstat-no" title="statement not covered" >      Defer.defer(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleResizeEvent())</span>;</span>
    } else {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private getFacetSliders(): any[] {</span>
<span class="cstat-no" title="statement not covered" >    const facetSliders = [];</span>
<span class="cstat-no" title="statement not covered" >    this.coveoRoot.findAll(Component.computeSelectorForType('FacetSlider')).forEach(<span class="fstat-no" title="function not covered" >facetSliderElement </span>=&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const facetSlider = Component.get(facetSliderElement);</span>
<span class="cstat-no" title="statement not covered" >      facetSlider &amp;&amp; facetSliders.push(facetSlider);</span>
    });
<span class="cstat-no" title="statement not covered" >    return facetSliders;</span>
  }
&nbsp;
  private getFacets(): any[] {
    const facets = [];
    this.coveoRoot.findAll(Component.computeSelectorForType('Facet')).forEach(<span class="fstat-no" title="function not covered" >facetElement </span>=&gt; {
<span class="cstat-no" title="statement not covered" >      const facet = Component.get(facetElement);</span>
<span class="cstat-no" title="statement not covered" >      facet &amp;&amp; facets.push(facet);</span>
    });
    return facets;
  }
&nbsp;
  private enableFacetPreservePosition(): void {
    this.getFacets().forEach(<span class="fstat-no" title="function not covered" >facet </span>=&gt; <span class="cstat-no" title="statement not covered" >(facet.options.preservePosition = true))</span>;
  }
&nbsp;
  private disableFacetPreservePosition(): void {
    this.getFacets().forEach(<span class="fstat-no" title="function not covered" >facet </span>=&gt; <span class="cstat-no" title="statement not covered" >(facet.options.preservePosition = false))</span>;
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private drawFacetSliderGraphs(): void {</span>
<span class="cstat-no" title="statement not covered" >    this.getFacetSliders().forEach(<span class="fstat-no" title="function not covered" >facetSlider </span>=&gt; <span class="cstat-no" title="statement not covered" >facetSlider.drawDelayedGraphData())</span>;</span>
  }
&nbsp;
