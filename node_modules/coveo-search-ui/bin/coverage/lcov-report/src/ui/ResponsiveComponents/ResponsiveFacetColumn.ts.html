...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/ResponsiveComponents/ResponsiveFacetColumn.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/ResponsiveComponents/ResponsiveFacetColumn.ts</span></h1>
    <h2>
        Statements: <span class="metric">96.73% <small>(148 / 153)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">74.55% <small>(41 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">96.97% <small>(32 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">96.53% <small>(139 / 144)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/ResponsiveComponents/</a> &#187; ResponsiveFacetColumn.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_ResponsiveFacets';
...
&nbsp;
  public dismissFacetSearches() {
    each(this.componentsInFacetColumn, component =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (component.facetSearch &amp;&amp; component.facetSearch.currentlyDisplayedResults) {
  ...
  private needSmallMode(): boolean {
    if (!this.searchInterface) {
      return (
        ...
        (Utils.isNullOrUndefined(this.breakpoint) ? new ResponsiveComponents().getMediumScreenWidth() : <span class="branch-1 cbranch-no" title="branch not covered" >this.breakpoint)</span>
      );
    }
...
<span class="cstat-no" title="statement not covered" >            component.facetSearch.positionSearchResults(this.dropdown.dropdownContent.element.el);</span>
          } else <span class="missing-if-branch" title="else path not taken" >E</span>if (facetSearch &amp;&amp; component.facetSearch.currentlyDisplayedResults) {
...
&nbsp;
  private restoreFacetPreservePositionValue() {
    each(this.componentsInFacetColumn, (component, index) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (component.options) {
...
&nbsp;
  private getDropdownHeaderLabel() {
    ...
    ComponentsTypes.getAllFacetsInstance(this.coveoRoot.find('.coveo-facet-column')).forEach(<span class="fstat-no" title="function not covered" >facet </span>=&gt; {
<span class="cstat-no" title="statement not covered" >      const options = facet.options as IResponsiveComponentOptions;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!dropdownHeaderLabel &amp;&amp; options.dropdownHeaderLabel) {</span>
<span class="cstat-no" title="statement not covered" >        dropdownHeaderLabel = options.dropdownHeaderLabel;</span>
      }
    });
&nbsp;
