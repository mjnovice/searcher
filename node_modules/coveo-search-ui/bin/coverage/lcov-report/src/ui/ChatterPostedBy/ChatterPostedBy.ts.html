...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.getFieldValue(this.result, 'sfcreatedbyname') != null) {
      let from = $$('span');
...
<span class="branch-1 cbranch-no" title="branch not covered" >          Utils.getFieldValue(this.result, 'sfuserid') != Utils.getFieldValue(this.result, 'sfinsertedbyid')</span>
        ) {
<span class="cstat-no" title="statement not covered" >          let onFeed = $$('span');</span>
<span class="cstat-no" title="statement not covered" >          let content = ` ${l(</span>
            'OnFeed',
