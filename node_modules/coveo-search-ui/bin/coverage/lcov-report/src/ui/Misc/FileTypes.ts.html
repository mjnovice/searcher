...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (loweredCaseFiletype[0] == '.') {
<span class="cstat-no" title="statement not covered" >      loweredCaseFiletype = loweredCaseFiletype.substring(1);</span>
    }
&nbsp;
