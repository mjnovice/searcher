...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">89.04% <small>(130 / 146)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">69.23% <small>(36 / 52)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">84% <small>(21 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">89.55% <small>(120 / 134)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_ResultsPreferences';
...
<span class="fstat-no" title="function not covered" >          radioButtonInstance </span>=&gt; {
<span class="cstat-no" title="statement not covered" >            this.fromPreferenceChangeEventToUsageAnalyticsLog(radioButtonInstance.isSelected() ? 'selected' : 'unselected', label);</span>
  ...
  private buildCheckboxesInput() {
    const createCheckbox = (label: string) =&gt; {
      const checkbox = new Checkbox(checkboxInstance =&gt; {
        this.fromPreferenceChangeEventToUsageAnalyticsLog(checkboxInstance.isSelected() ? <span class="branch-0 cbranch-no" title="branch not covered" >'selected' </span>: 'unselected', label);
        this.save();
...
&nbsp;
  private fromInputToPreferences() {
    this.preferences = this.preferences || <span class="branch-1 cbranch-no" title="branch not covered" >{</span>
      openInOutlook: false,
...
&nbsp;
    _.each(this.preferencePanelCheckboxInputs, (checkbox: Checkbox, label: string) =&gt; {
      if (label == l('OpenInOutlookWhenPossible')) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isSelected(l('OpenInOutlookWhenPossible'), label, checkbox)) {
<span class="cstat-no" title="statement not covered" >          this.preferences.openInOutlook = true;</span>
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.preferences.openInOutlook != null) {
<span class="cstat-no" title="statement not covered" >          this.preferences.openInOutlook = false;</span>
        }
      }
      if (label == l('AlwaysOpenInNewWindow')) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isSelected(l('AlwaysOpenInNewWindow'), label, checkbox)) {
<span class="cstat-no" title="statement not covered" >          this.preferences.alwaysOpenInNewWindow = true;</span>
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.preferences.alwaysOpenInNewWindow != null) {
<span class="cstat-no" title="statement not covered" >          this.preferences.alwaysOpenInNewWindow = false;</span>
        }
      }
    });
&nbsp;
    _.each(this.preferencePanelRadioInputs, (radio: RadioButton, label: string) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isSelected(l('On'), label, radio)) {
<span class="cstat-no" title="statement not covered" >        this.preferences.enableQuerySyntax = true;</span>
      }
      <span class="missing-if-branch" title="if path not taken" >I</span>if (this.isSelected(l('Off'), label, radio)) {
<span class="cstat-no" title="statement not covered" >        this.preferences.enableQuerySyntax = false;</span>
      }
...
<span class="cstat-no" title="statement not covered" >      this.preferencePanelCheckboxInputs[l('OpenInOutlookWhenPossible')].select(false);</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.preferences.alwaysOpenInNewWindow) {
<span class="cstat-no" title="statement not covered" >      this.preferencePanelCheckboxInputs[l('AlwaysOpenInNewWindow')].select(false);</span>
    }
  }
&nbsp;
  private fromPreferencesToRadioInput() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.preferences.enableQuerySyntax === true) {
<span class="cstat-no" title="statement not covered" >      this.preferencePanelRadioInputs[l('On')].select(false);</span>
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.preferences.enableQuerySyntax === false) {
<span class="cstat-no" title="statement not covered" >      this.preferencePanelRadioInputs[l('Off')].select(false);</span>
    } else {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (needToSave) {
      Defer.defer(() =&gt; {
        this.save();
      });
    }
