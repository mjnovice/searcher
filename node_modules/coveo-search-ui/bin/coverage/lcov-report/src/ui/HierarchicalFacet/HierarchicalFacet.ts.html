...
<div class="header high">
    ...
    <h2>
        ...
        Branches: <span class="metric">67.2% <small>(127 / 189)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">81.82% <small>(90 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">83.19% <small>(376 / 452)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">5316</span>
<span class="cline-any cline-yes">5316</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">6454</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6454</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
   ...
   */
  public selectValue(value: FacetValue | string, <span class="missing-if-branch" title="else path not taken" >E</span>selectChildren = !this.options.useAnd) {
    this.ensureDom();
...
&nbsp;
   ...
   * the [`useAnd`]{@link Facet.options.useAnd} option value set for this `HierarchicalFacet`.
   */
  public selectMultipleValues(values: FacetValue[] | string[], <span class="missing-if-branch" title="else path not taken" >E</span>selectChildren = !this.options.useAnd): void {
    this.ensureDom();
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public excludeValue(value: FacetValue | string, <span class="cstat-no" title="statement not covered" >excludeChildren = !this.options.useAnd)</span></span>: void {
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public unexcludeValue(value: FacetValue | string, <span class="cstat-no" title="statement not covered" >unexludeChildren = !this.options.useAnd)</span></span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
<span class="cstat-no" title="statement not covered" >    let valueHierarchy = this.getValueFromHierarchy(value);</span>
...
&nbsp;
   ...
   * of the [`useAnd`]{@link Facet.options.useAnd} option value set for this `HierarchicalFacet`.
   */
  public deselectMultipleValues(values: FacetValue[] | string[], <span class="missing-if-branch" title="else path not taken" >E</span>deselectChildren = !this.options.useAnd): void {
    this.ensureDom();
    this.ensureValueHierarchyExists(values);
    _.each(values as FacetValue[], value =&gt; {
      let valueHierarchy = this.getValueFromHierarchy(value);
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public toggleSelectValue(value: FacetValue | string)</span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  public toggleExcludeValue(value: FacetValue | string)</span>: void {
<span class="cstat-no" title="statement not covered" >    this.ensureDom();</span>
<span class="cstat-no" title="statement not covered" >    this.ensureValueHierarchyExists([value]);</span>
...
<span class="cstat-no" title="statement not covered" >    let match = _.first(</span>
      _.filter&lt;IValueHierarchy&gt;(this.getAllValueHierarchy(), <span class="fstat-no" title="function not covered" >existingValue </span>=&gt; {
...
<span class="cstat-no" title="statement not covered" >    let facetValues = _.compact(</span>
      _.map(match, <span class="fstat-no" title="function not covered" >gotAMatch </span>=&gt; {
...
<span class="cstat-no" title="statement not covered" >    this.excludeMultipleValues(</span>
      _.map(children, <span class="fstat-no" title="function not covered" >child </span>=&gt; {
...
<span class="cstat-no" title="statement not covered" >    this.unexcludeMultipleValues(</span>
      _.map(children, <span class="fstat-no" title="function not covered" >child </span>=&gt; {
<span class="cstat-no" title="statement not covered" >        return child.facetValue;</span>
      })
    );
