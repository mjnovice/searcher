...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">80.78% <small>(618 / 765)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">62.66% <small>(151 / 241)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">75.46% <small>(123 / 163)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">80.44% <small>(580 / 721)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
2040
2041
2042</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_Facet';
  ...
  static options: IFacetOptions = {
    ...
    sortCriteria: ComponentOptions.buildStringOption&lt;FacetSortCriterion&gt;({
      postProcessing: (value, options: IFacetOptions) =&gt;
        value || (options.availableSorts.length &gt; 0 ? (options.availableSorts[0] as FacetSortCriterion) : <span class="branch-1 cbranch-no" title="branch not covered" >'occurrences')</span>,
      section: 'Sorting'
    }),
    /**
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if ($$(this.element).hasClass('coveo-active')) {
...
&nbsp;
  public createDom() {
    ...
    if (this.facetSettings &amp;&amp; this.options.enableSettingsFacetState) {
      const loadOnce = &lt;(args: INewQueryEventArgs) =&gt; any&gt;_.once(<span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >    const valuesForAnalytics = [];</span>
...
<span class="cstat-no" title="statement not covered" >    const valuesThatStays = this.values.getSelected().concat(this.values.getExcluded());</span>
...
<span class="cstat-no" title="statement not covered" >    this.triggerNewQuery(<span class="fstat-no" title="function not covered" >() =&gt;</span></span>
<span class="cstat-no" title="statement not covered" >      this.usageAnalytics.logSearchEvent&lt;IAnalyticsFacetMeta&gt;(analyticsActionCauseList.facetSelectAll, {</span>
        facetId: this.options.id,
        facetField: this.options.field.toString(),
        facetTitle: this.options.title
      })
...
<span class="cstat-no" title="statement not covered" >      const excludedValues = this.values.getExcluded();</span>
<span class="cstat-no" title="statement not covered" >      const selectedValues = this.values.getSelected();</span>
&nbsp;
...
&nbsp;
  protected initSearchAlertEvents() {
    this.bind.onRootElement(SearchAlertsEvents.searchAlertsPopulateMessage, <span class="fstat-no" title="function not covered" >(args: ISearchAlertsPopulateMessageEventArgs)</span> =&gt;
<span class="cstat-no" title="statement not covered" >      this.handlePopulateSearchAlerts(args)</span>
    );
  }
&nbsp;
  protected handleOmniboxWithStaticValue(eventArg: IPopulateOmniboxEventArgs) {
    ...
    const match = _.first(
      _.filter(this.getDisplayedValues(), <span class="fstat-no" title="function not covered" >(displayedValue: string)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >        const value = this.getValueCaption(this.facetValuesList.get(displayedValue).facetValue);</span>
<span class="cstat-no" title="statement not covered" >        return regex.test(value);</span>
      }),
      this.options.numberOfValuesInOmnibox
    );
    const facetValues = _.map(match, <span class="fstat-no" title="function not covered" >(gotAMatch: string)</span> =&gt; {
...
&nbsp;
  protected rebuildValueElements() {
    ...
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.shouldRenderFacetSearch()) {
<span class="cstat-no" title="statement not covered" >      this.updateSearchElement();</span>
    }
  }
&nbsp;
  protected updateSearchElement(<span class="missing-if-branch" title="if path not taken" >I</span>moreValuesAvailable = true) {
...
<span class="cstat-no" title="statement not covered" >      $$(this.searchContainer.label).on('click', <span class="fstat-no" title="function not covered" >e </span>=&gt; <span class="cstat-no" title="statement not covered" >this.toggleSearchMenu(e))</span>;</span>
    }
&nbsp;
...
&nbsp;
  private checkForValueCaptionType() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.valueCaption &amp;&amp; typeof this.options.valueCaption == 'function') {
...
&nbsp;
  private initDependsOnManager() {
    const facetInfo: IDependentFacet = {
      reset: <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.reset(),</span>
      toggleDependentFacet: <span class="fstat-no" title="function not covered" >dependentFacet </span>=&gt; <span class="cstat-no" title="statement not covered" >this.toggleDependentFacet(dependentFacet),</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private toggleDependentFacet(dependentFacet: Component)</span> {
<span class="cstat-no" title="statement not covered" >    this.getSelectedValues().length ? dependentFacet.enable() : dependentFacet.disable();</span>
  }
&nbsp;
  private dependsOnUpdateParentDisplayValue() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.dependsOn) {
      return;
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    const masterFacetComponent = ComponentsTypes.getAllFacetsInstance(this.root).filter(<span class="fstat-no" title="function not covered" >(cmp: Facet)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const idFacet = cmp instanceof Facet;</span>
<span class="cstat-no" title="statement not covered" >      return idFacet &amp;&amp; cmp.options.id === this.options.dependsOn;</span>
    }) as Facet[];
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!masterFacetComponent.length) {</span>
<span class="cstat-no" title="statement not covered" >      this.logger.warn(</span>
...
<span class="cstat-no" title="statement not covered" >    if (masterFacetComponent.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      this.logger.warn(</span>
...
<span class="cstat-no" title="statement not covered" >    const masterFacet = masterFacetComponent[0];</span>
<span class="cstat-no" title="statement not covered" >    masterFacet.keepDisplayedValuesNextTime = false;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      const valueToSet = {};</span>
...
&nbsp;
  private handleQueryStateChangedOperator(operator: string) {
    if (operator == 'and') {
      this.switchToAnd();
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (operator == 'or') {
      this.switchToOr();
    }
  }
&nbsp;
  private handleQueryStateChangedIncluded(includedChanged) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNonEmptyArray(toUnSelect)) {
...
&nbsp;
  private handleQueryStateChangedExcluded(excludedChanged) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Utils.isNonEmptyArray(toUnExclude)) {
...
&nbsp;
  private handleLookupvalueChanged(lookupFieldChanged: { [value: string]: string }) {
    _.each(lookupFieldChanged, <span class="fstat-no" title="function not covered" >(lookupvalue, value)</span> =&gt; {
...
&nbsp;
    if (this.listenToQueryStateChange) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrEmptyString(operator)) {
        this.handleQueryStateChangedOperator(operator);
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(includedChanged)) {
        this.handleQueryStateChangedIncluded(includedChanged);
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(excludedChanged)) {
        this.handleQueryStateChangedExcluded(excludedChanged);
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!Utils.isNullOrUndefined(lookupValueChanged)) {
...
<span class="cstat-no" title="statement not covered" >    const regex = new RegExp('^' + eventArg.completeQueryExpression.regex.source, 'i');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    const promise = new Promise&lt;IOmniboxDataRow&gt;(<span class="fstat-no" title="function not covered" >(resolve, reject)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const searchParameters = new FacetSearchParameters(this);</span>
...
<span class="cstat-no" title="statement not covered" >      this.facetQueryController</span>
        .search(searchParameters)
        .then(<span class="fstat-no" title="function not covered" >fieldValues </span>=&gt; {
<span class="cstat-no" title="statement not covered" >          const facetValues = _.map(</span>
            _.filter(fieldValues, <span class="fstat-no" title="function not covered" >(fieldValue: IIndexFieldValue)</span> =&gt; {
...
<span class="cstat-no" title="statement not covered" >          const element = new OmniboxValuesList(this, facetValues, eventArg, OmniboxValueElement).build();</span>
<span class="cstat-no" title="statement not covered" >          resolve({ element: element, zIndex: this.omniboxZIndex });</span>
        })
...
<span class="cstat-no" title="statement not covered" >      const elementToScroll: any = this.options.scrollContainer == document.body ? window : this.options.scrollContainer;</span>
...
<span class="cstat-no" title="statement not covered" >      const scrollToOffset = <span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        if (elementToScroll instanceof Window) {</span>
<span class="cstat-no" title="statement not covered" >          window.scrollTo(0, new Win(elementToScroll).scrollY() + offset);</span>
        } else {
...
&nbsp;
    new AccessibleButton()
      ...
      .withSelectAction(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickMore())</span>
      .build();
&nbsp;
    return more;
  }
...
&nbsp;
    new AccessibleButton()
      ...
      .withSelectAction(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleClickLess())</span>
      .build();
&nbsp;
    return less;
  }
...
<span class="cstat-no" title="statement not covered" >          this.triggerUpdateDeltaQuery(</span>
            _.filter(this.values.getAll(), <span class="fstat-no" title="function not covered" >(facetValue: FacetValue)</span> =&gt; <span class="cstat-no" title="statement not covered" >!facetValue.selected &amp;&amp; !facetValue.excluded)</span>
          );
        } else <span class="cstat-no" title="statement not covered" >if (this.values.hasSelectedOrExcludedValues() &amp;&amp; !this.options.useAnd) {</span>
<span class="cstat-no" title="statement not covered" >          this.values.updateDeltaWithFilteredFacetValues(new FacetValues(), this.options.isMultiValueField);</span>
...
<span class="cstat-no" title="statement not covered" >      const values: FacetValues = new FacetValues();</span>
...
<span class="cstat-no" title="statement not covered" >      this.values.updateDeltaWithFilteredFacetValues(values, this.options.isMultiValueField);</span>
<span class="cstat-no" title="statement not covered" >      this.cleanupDeltaValuesForMultiValueField();</span>
<span class="cstat-no" title="statement not covered" >      this.rebuildValueElements();</span>
<span class="cstat-no" title="statement not covered" >      this.hideWaitingAnimation();</span>
    });
  }
...
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private cleanupDeltaValuesForMultiValueField() {</span></span>
...
<span class="cstat-no" title="statement not covered" >    if (this.options.isMultiValueField) {</span>
<span class="cstat-no" title="statement not covered" >      _.each(this.values.getAll(), <span class="fstat-no" title="function not covered" >v </span>=&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (v.occurrences == 0 &amp;&amp; !v.selected &amp;&amp; !v.excluded) {</span>
<span class="cstat-no" title="statement not covered" >          this.values.remove(v.value);</span>
        }
      });
<span class="cstat-no" title="statement not covered" >      this.nbAvailableValues = this.values.getAll().length;</span>
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    const info: any = {};</span>
