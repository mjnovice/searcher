...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">96.05% <small>(73 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.facet.options.lookupField != null) {
<span class="cstat-no" title="statement not covered" >      completeFacetWithStandardValues = false;</span>
    }
&nbsp;
