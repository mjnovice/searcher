...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/NoopComponent/NoopComponent.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/NoopComponent/NoopComponent.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/NoopComponent/</a> &#187; NoopComponent.ts</div>
</div>
<div class="body">
...
&nbsp;
  constructor(element: HTMLElement, options: any, bindings: IComponentBindings) {
    super(element, NoopComponent.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
