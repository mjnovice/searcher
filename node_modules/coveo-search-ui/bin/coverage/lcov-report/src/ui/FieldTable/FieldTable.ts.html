...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">99.12% <small>(113 / 114)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_FieldTable';
...
&nbsp;
    new AccessibleButton()
      ...
      .withSelectAction(<span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>toggleAction())</span>
      .withOwner(this.bind)
      .withLabel(l('Toggle'))
      .build();
&nbsp;
...
class ValueRow extends FieldValue {
  ...
  static options: IValueRowOptions = {
    caption: ComponentOptions.buildStringOption({
      postProcessing: (value, options) =&gt; value || <span class="branch-1 cbranch-no" title="branch not covered" >options.field.substr(1)</span>
    })
  };
&nbsp;
