...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">85.79% <small>(163 / 190)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">53.13% <small>(34 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">80% <small>(28 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">85.64% <small>(161 / 188)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  private pushCustomEvent(
    ...
    return this.sendToCloud ? this.endpoint.sendCustomEvent(customEvent) : <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve(null);</span>
  }
&nbsp;
...
&nbsp;
    ...
    return this.sendToCloud ? this.endpoint.sendDocumentViewEvent(event) : <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve(null);</span>
  }
&nbsp;
