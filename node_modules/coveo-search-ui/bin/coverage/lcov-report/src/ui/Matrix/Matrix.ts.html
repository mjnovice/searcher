...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">79.25% <small>(294 / 371)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">64.38% <small>(94 / 146)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">65.33% <small>(49 / 75)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">79.72% <small>(283 / 355)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
938
939
940</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cstat-no" title="statement not covered" >      this.previewTimeout = window.setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
...
<span class="cstat-no" title="statement not covered" >        result.then(<span class="fstat-no" title="function not covered" >(builtResultElement: HTMLElement)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          html += builtResultElement.outerHTML;</span>
        });
      });
<span class="cstat-no" title="statement not covered" >      Promise.all(instantiatedResults).then(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >        cell.updatePreview(html);</span>
      });
    });
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private instantiateTemplate(result: IQueryResult)</span>: Promise&lt;HTMLElement&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return this.options.previewTemplate</span>
      .instantiateToElement(result, {
        checkCondition: false,
        responsiveComponents: this.searchInterface.responsiveComponents
      })
      .then(<span class="fstat-no" title="function not covered" >(content: HTMLElement)</span> =&gt; {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return Initialization.automaticallyCreateComponentsInside(content, initParameters).initResult.then(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
...
<span class="cstat-no" title="statement not covered" >    let columnFieldExpression =</span>
