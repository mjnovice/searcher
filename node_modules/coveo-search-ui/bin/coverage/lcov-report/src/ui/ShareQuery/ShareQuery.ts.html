...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">95.12% <small>(78 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
   ...
   */
  public close() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.modalbox) {
      this.modalbox.close();
      this.modalbox = null;
    }
  }
&nbsp;
  ...
  public getLinkToThisQuery(): string {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.linkToThisQuery) {
<span class="cstat-no" title="statement not covered" >      this.buildLinkToThisQuery();</span>
    }
...
&nbsp;
  ...
  public setLinkToThisQuery(link: string): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.linkToThisQuery) {
...
&nbsp;
  ...
  public setCompleteQuery(completeQuery: string) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.completeQuery) {
      this.buildCompleteQuery();
    }
