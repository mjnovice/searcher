...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Distance/GoogleApiPositionProvider.ts</title>
    <meta charset="utf-8">
...
<div class="header medium">
    <h1>Code coverage report for <span class="entity">src/ui/Distance/GoogleApiPositionProvider.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Distance/</a> &#187; GoogleApiPositionProvider.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { EndpointCaller } from '../../rest/EndpointCaller';
...
<span class="fstat-no" title="function not covered" >  constructor(private <span class="cstat-no" title="statement not covered" >googleApiKey: string)</span></span> {}
&nbsp;
<span class="fstat-no" title="function not covered" >  public async getPosition(): Promise&lt;IGeolocationPosition&gt; {</span>
    const <span class="cstat-no" title="statement not covered" >responseData = <span class="cstat-no" title="statement not covered" >await new EndpointCaller().call&lt;IGeolocationResponse&gt;({</span></span>
    ...
    const <span class="cstat-no" title="statement not covered" >location = responseData.data.location;</span>
