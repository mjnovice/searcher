...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_ResultRating';
...
&nbsp;
      if (this.bindings.searchInterface.options.enableCollaborativeRating) {
        new AccessibleButton()
          .withElement(star)
          .withSelectAction(<span class="fstat-no" title="function not covered" >e </span>=&gt; {
<span class="cstat-no" title="statement not covered" >            const targetElement: HTMLElement = &lt;HTMLElement&gt;e.currentTarget;</span>
...
<span class="cstat-no" title="statement not covered" >        this.logger.error('An error occurred while rating the item');</span>
      });
  }
}
&nbsp;
