...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">91.28% <small>(157 / 172)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">72.82% <small>(75 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">90.63% <small>(29 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">91.98% <small>(149 / 162)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1454</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2765</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
&nbsp;
      ...
      $$(element).on('touchend', () =&gt; {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (longPressTimer) {
    ...
    if (/^\s*$/.test(this.element.innerHTML)) {
      if (!this.options.titleTemplate) {
        ...
        this.element.innerHTML = newTitle
          ...
          : <span class="branch-1 cbranch-no" title="branch not covered" >this.result.clickUri;</span>
      }
    }
  }
  /**
...
&nbsp;
  private setHrefIfNotAlready() {
    ...
    if (this.elementIsAnAnchor() &amp;&amp; !Utils.isNonEmptyString($$(this.element).getAttribute('href'))) {
      ...
      if (this.options.alwaysOpenInNewWindow &amp;&amp; !(this.options.openInOutlook &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.hasOutlookField())</span>) {
