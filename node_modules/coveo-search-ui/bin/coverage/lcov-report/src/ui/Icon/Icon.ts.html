...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">84.72% <small>(61 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">60% <small>(24 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (this.element.parentElement != null) {
...
<span class="cstat-no" title="statement not covered" >        var qv = &lt;any&gt;Component.get(possibleInternalQuickview);</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!bindings &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >result.searchInterface)</span> {
      // try to resolve results bindings automatically
<span class="cstat-no" title="statement not covered" >      bindings = result.searchInterface.getBindings();</span>
    }
