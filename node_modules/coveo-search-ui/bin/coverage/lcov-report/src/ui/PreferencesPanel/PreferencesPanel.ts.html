...
<span class="cstat-no" title="statement not covered" >      args.menuData.push({</span>
    ...
    this.bind.onRootElement(InitializationEvents.afterComponentsInitialization, <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.content = $$(this.element).children();</span>
    });
  }
&nbsp;
  /**
  ...
  public open(): void {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.modalbox == null) {
      let root = $$('div');
      _.each(this.content, <span class="fstat-no" title="function not covered" >oneChild </span>=&gt; {
<span class="cstat-no" title="statement not covered" >        root.append(oneChild);</span>
      });
&nbsp;
      this.modalbox = this.ModalBox.open(root.el, {
        title: l('Preferences'),
        validation: <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >          this.cleanupOnExit();</span>
