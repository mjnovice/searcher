...
<html lang="en">
<head>
    <title>Code coverage report for src/ui/Debug/DebugForResult.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/ui/Debug/DebugForResult.ts</span></h1>
    <h2>
        Statements: <span class="metric">88.71% <small>(55 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/ui/Debug/</a> &#187; DebugForResult.ts</div>
</div>
<div class="body">
  ...
  private buildFieldsSection(result: IQueryResult) {
    return this.fetchFields().then((fieldDescriptions: IStringMap&lt;IFieldDescription&gt;) =&gt; {
      ...
      _.each(result.raw, (value: any, key: string) =&gt; {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (fieldDescription == null &amp;&amp; key.match(/^sys/)) {
<span class="cstat-no" title="statement not covered" >          fieldDescription = fieldDescriptions['@' + key.substr(3)];</span>
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (fieldDescription.splitGroupByField &amp;&amp; _.isString(value)) {
...
&nbsp;
      if (termsWeight &amp;&amp; termsWeight[1]) {
        ...
        rankingInfo['Terms weights'] = _.object(
          _.map(terms, <span class="fstat-no" title="function not covered" >term </span>=&gt; {
<span class="cstat-no" title="statement not covered" >            let words = _.object(</span>
              _.map(StringUtils.match(term[1], /([^:]+): ([0-9]+), ([0-9]+); /g), <span class="fstat-no" title="function not covered" >word </span>=&gt; {
