...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.3% <small>(181 / 194)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">71.43% <small>(20 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">81.82% <small>(36 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">95.05% <small>(173 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
  ...
  constructor(
    ...
    private <span class="missing-if-branch" title="if path not taken" >I</span>ModalBox = ModalBoxModule
  ) {
...
&nbsp;
  ...
  public executeAdvancedSearch() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.needToExecuteAdvancedSearch) {
...
&nbsp;
  private handleClearBreadcrumb() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.needToPopulateBreadcrumb) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private handleQuerySummaryCancelLastAction() {</span>
<span class="cstat-no" title="statement not covered" >    this.needToExecuteAdvancedSearch = false;</span>
<span class="cstat-no" title="statement not covered" >    this.reset();</span>
<span class="cstat-no" title="statement not covered" >    this.needToExecuteAdvancedSearch = true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  private handlePopulateMenu(args: ISettingsPopulateMenuArgs)</span> {</span>
...
<span class="cstat-no" title="statement not covered" >        options = _.extend({}, options, { closeModalBox: false });</span>
...
&nbsp;
  private bindEvents() {
    ...
    this.bind.onRootElement(SettingsEvents.settingsPopulateMenu, <span class="fstat-no" title="function not covered" >(args: ISettingsPopulateMenuArgs)</span> =&gt; <span class="cstat-no" title="statement not covered" >this.handlePopulateMenu(args))</span>;
    this.bind.onRootElement(QueryEvents.buildingQuery, (data: IBuildingQueryEventArgs) =&gt; this.handleBuildingQuery(data));
    this.bind.onRootElement(AdvancedSearchEvents.executeAdvancedSearch, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.executeAdvancedSearch())</span>;
    this.bind.onRootElement(QuerySummaryEvents.cancelLastAction, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.handleQuerySummaryCancelLastAction())</span>;
  }
}
&nbsp;
