...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">85.21% <small>(288 / 338)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">61.67% <small>(37 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">71.95% <small>(59 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">86.41% <small>(267 / 309)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
679
680
681</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import 'styling/_ResultsFiltersPreferences';
...
&nbsp;
  ...
  constructor(public element: HTMLElement, public options: IResultsFiltersPreferencesOptions, public bindings: IComponentBindings) {
    super(element, ResultsFiltersPreferences.ID, bindings)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.preferencePanel) {
<span class="cstat-no" title="statement not covered" >      this.logger.warn(`Cannot instantiate ResultsFilterPreferences, as there is no "CoveoPreferencesPanel" in your page !`);</span>
      return;
    }
...
&nbsp;
    ...
    this.bind.oneRootElement(InitializationEvents.afterComponentsInitialization, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.createDom())</span>;
&nbsp;
    this.bind.oneQueryState(MODEL_EVENTS.CHANGE_ONE, QUERY_STATE_ATTRIBUTES.T, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.fromPreferencesToCheckboxInput())</span>;
  }
&nbsp;
  public createDom() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.showAdvancedFilters) {
...
<span class="cstat-no" title="statement not covered" >    this.hideAdvancedFilterBuilder();</span>
  }
&nbsp;
  private bindPreferencePanelEvent() {
    this.bind.on(this.preferencePanel, PreferencesPanelEvents.savePreferences, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.save())</span>;
    this.bind.on(this.preferencePanel, PreferencesPanelEvents.exitPreferencesWithoutSave, <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.exitWithoutSave())</span>;
  }
&nbsp;
  private bindBreadcrumbEvent() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.includeInBreadcrumb) {
...
&nbsp;
  private handleBuildingQuery(args: IBuildingQueryEventArgs) {
    _.each(this.getActiveFilters(), filter =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isNonEmptyString(filter.expression)) {
...
&nbsp;
  private handlePopulateBreadcrumb(args: IPopulateBreadcrumbEventArgs) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isNonEmptyArray(actives)) {
...
&nbsp;
  private buildAdvancedFilters() {
    ...
    $$(this.advancedFilters).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.openAdvancedFilterSectionOrSaveFilters())</span>;
    const onlineHelp = $$(
      'a',
      {
...
&nbsp;
  private buildAdvancedFilterInput() {
    this.advancedFiltersTextInputCaption = new TextInput(<span class="fstat-no" title="function not covered" >() =&gt; {</span>}, l('Caption'));
&nbsp;
    this.advancedFiltersTextInputCaption.getInput().setAttribute('required', '');
&nbsp;
    this.advancedFiltersTextInputExpression = new TextInput(<span class="fstat-no" title="function not covered" >() =&gt; {</span>}, l('Expression'));
&nbsp;
    this.advancedFiltersTextInputExpression.getInput().setAttribute('required', '');
&nbsp;
    this.advancedFiltersTabSelect = new MultiSelect(<span class="fstat-no" title="function not covered" >() =&gt; {</span>}, this.getAllTabs(), l('Tab'));
  }
&nbsp;
...
&nbsp;
    saveFormButton.on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      formSubmit.el.click();</span>
    });
    closeFormButton.on('click', <span class="fstat-no" title="function not covered" >() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.hideAdvancedFilterBuilder();</span>
    });
&nbsp;
...
&nbsp;
  private getAllTabs() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (tabRef) {
      ...
      return _.map(tabsElement, <span class="fstat-no" title="function not covered" >(tabElement: HTMLElement)</span> =&gt; {
  ...
  private buildDeleteAdvancedFilter() {
    _.each(this.preferences, filter =&gt; {
      if (filter.custom) {
        ...
        $$(deleteElement).on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.confirmDelete(filter, filterElement))</span>;
      }
    });
  }
&nbsp;
  private buildEditAdvancedFilter() {
    _.each(this.preferences, filter =&gt; {
      if (filter.custom) {
        ...
        editElement.on('click', <span class="fstat-no" title="function not covered" >() =&gt; <span class="cstat-no" title="statement not covered" ></span>this.editElement(filter, filterElement))</span>;
      }
    });
  }
&nbsp;
...
&nbsp;
    const onSelectAction = <span class="fstat-no" title="function not covered" >() =&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >      const isSelected = filter.selected;</span>
...
<span class="cstat-no" title="statement not covered" >    const oldCaption = this.preferences[filter.caption].caption;</span>
<span class="cstat-no" title="statement not covered" >    const oldTab = this.preferences[filter.caption].tab;</span>
<span class="cstat-no" title="statement not covered" >    const oldExpression = this.preferences[filter.caption].expression;</span>
<span class="cstat-no" title="statement not covered" >    this.deleteFilterPreference(filter, filterElement);</span>
...
<span class="cstat-no" title="statement not covered" >    this.advancedFiltersTextInputCaption.setValue(toPopulate.caption);</span>
<span class="cstat-no" title="statement not covered" >    this.advancedFiltersTextInputExpression.setValue(toPopulate.expression);</span>
<span class="cstat-no" title="statement not covered" >    this.advancedFiltersTabSelect.setValue(toPopulate.tab);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      this.showAdvancedFilterBuilder();</span>
    }
  }
&nbsp;
...
&nbsp;
  private fromPreferencesToCheckboxInput() {
    ...
    _.each(this.getDormantFilters(), <span class="fstat-no" title="function not covered" >(filter: IResultFilterPreference)</span> =&gt; {
<span class="cstat-no" title="statement not covered" >      this.preferencePanelCheckboxInput[filter.caption].select();</span>
    });
  }
&nbsp;
  private fromCheckboxInputToPreferences() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.preferencePanelCheckboxInput) {
  ...
  private fromResultsFilterOptionToResultsPreferenceInterface() {
    ...
    _.each(&lt;any&gt;this.options.filters, (filter: { expression: string; tab?: string[]; selected?: boolean }, caption: string) =&gt; {
      ret[caption] = {
        expression: filter.expression,
        tab: filter.tab,
        selected: filter.selected ? <span class="branch-0 cbranch-no" title="branch not covered" >filter.selected </span>: false,
        custom: false,
        caption: caption
      };
    });
...
&nbsp;
<span class="fstat-no" title="function not covered" >  private enlargeModalBox() {</span>
<span class="cstat-no" title="statement not covered" >    const modalBoxContainer = $$(document.body).find('.coveo-modal-container');</span>
<span class="cstat-no" title="statement not covered" >    if (modalBoxContainer) {</span>
<span class="cstat-no" title="statement not covered" >      $$(modalBoxContainer).addClass('coveo-mod-big');</span>
    }
  }
&nbsp;
  private shrinkModalBox() {
    const modalBoxContainer = $$(document.body).find('.coveo-modal-container');
    <span class="missing-if-branch" title="if path not taken" >I</span>if (modalBoxContainer) {
<span class="cstat-no" title="statement not covered" >      $$(modalBoxContainer).removeClass('coveo-mod-big');</span>
    }
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  private showAdvancedFilterBuilder() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.advancedFiltersBuilder) {</span>
<span class="cstat-no" title="statement not covered" >      $$(this.advancedFiltersBuilder).addClass('coveo-active');</span>
<span class="cstat-no" title="statement not covered" >      this.enlargeModalBox();</span>
    }
  }
&nbsp;
  private hideAdvancedFilterBuilder() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.advancedFiltersBuilder) {
