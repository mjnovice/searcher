...
&nbsp;
  private formatQueryDuration(durationInMillis: number): string {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (durationInMillis == undefined) {
<span class="cstat-no" title="statement not covered" >      return l('Unavailable');</span>
    } else {
