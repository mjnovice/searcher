...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">88.14% <small>(171 / 194)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">56% <small>(28 / 50)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">73.68% <small>(28 / 38)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">87.63% <small>(163 / 186)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    this.bind.onRootElement(QueryEvents.querySuccess, () =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!once) {
        ...
        this.queryController
          ...
          .then(() =&gt; {
            this.bind.onRootElement(SettingsEvents.settingsPopulateMenu, (args: ISettingsPopulateMenuArgs) =&gt; {
              <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.enableFollowQuery) {
                args.menuData.push({
          ...
          .catch((e: AjaxError) =&gt; {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (e.status != 403) {
              throw e;
            }
          });
      }
...
&nbsp;
  private handleSearchAlertsFail() {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.modal != null) {
      const modalBody = $$(this.modal.wrapper).find('.coveo-modal-body');
      $$(modalBody).empty();
<span class="cstat-no" title="statement not covered" >      $$(modalBody).append(this.getFailureMessage().el);</span>
    }
  }
&nbsp;
...
&nbsp;
    ...
    if (subscription.name) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (subscription.name == '&lt;empty&gt;') {
<span class="cstat-no" title="statement not covered" >        context = '&amp;lt;empty&amp;gt;';</span>
      } else {
      ...
      context = _.escape(typeConfig.query.q) || <span class="branch-1 cbranch-no" title="branch not covered" >l('EmptyQuery');</span>
    } else {
      const typeConfig = &lt;ISubscriptionItemRequest&gt;subscription.typeConfig;
      context = _.escape(typeConfig.title || <span class="branch-1 cbranch-no" title="branch not covered" >typeConfig.id)</span>;
    }
&nbsp;
    const row = $$('tr', {
...
&nbsp;
      this.queryController
        ...
        .then(() =&gt; {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (subscription.type == SUBSCRIPTION_TYPE.followDocument) {
...
<span class="cstat-no" title="statement not covered" >          const eventArgs: ISearchAlertsEventArgs = { subscription: subscription };</span>
...
<span class="cstat-no" title="statement not covered" >    return new SearchAlerts(element, options, (&lt;SearchInterface&gt;get(root, SearchInterface)).getBindings());</span>
  }
}
&nbsp;
