...
<span class="cstat-no" title="statement not covered" >        this.showMessage($$(args.dom), l('SubscriptionsMessageFollow'), false);</span>
      }
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    this.closeTimeout = window.setTimeout(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
