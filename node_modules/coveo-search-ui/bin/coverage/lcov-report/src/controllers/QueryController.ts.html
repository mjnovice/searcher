...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">76.82% <small>(222 / 289)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">56.96% <small>(45 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">70.37% <small>(38 / 54)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">78.14% <small>(218 / 279)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
673
674
675</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { history } from 'coveo.analytics';
...
&nbsp;
    this.closeModalBoxIfNeeded(options ? options.closeModalBox : <span class="branch-1 cbranch-no" title="branch not covered" >undefined)</span>;
&nbsp;
...
&nbsp;
  private getLastSearchUid(): string {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.lastSearchUid != null) {
...
&nbsp;
    ...
    return enableHistory &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.getLastQueryHash() == this.queryHash(query, queryResults);</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        graph.appendChild(</span>
