...
<div class="header high">
    ...
    <h2>
        Statements: <span class="metric">93.33% <small>(182 / 195)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">83.51% <small>(81 / 97)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">89.29% <small>(25 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">93.12% <small>(176 / 189)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    if (this.facet.options &amp;&amp; this.facet.options.graph &amp;&amp; this.rangeValuesForGraphToUse == undefined) {
      ...
      const rawValues = groupByResult ? groupByResult.values : <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
...
<span class="cstat-no" title="statement not covered" >    return map(this.rangeValuesForGraphToUse, <span class="fstat-no" title="function not covered" >value </span>=&gt; {</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Utils.isNullOrUndefined(param)) {
      return value || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return param + ' ' + (value || '');</span>
    }
  }
}
&nbsp;</pre></td></tr>
