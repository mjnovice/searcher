...
<html lang="en">
<head>
    <title>Code coverage report for src/magicbox/Expression/ExpressionConstant.ts</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">src/magicbox/Expression/ExpressionConstant.ts</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">src/magicbox/Expression/</a> &#187; ExpressionConstant.ts</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Expression } from './Expression';
...
&nbsp;
<span class="fstat-no" title="function not covered" >  public toString() {</span>
