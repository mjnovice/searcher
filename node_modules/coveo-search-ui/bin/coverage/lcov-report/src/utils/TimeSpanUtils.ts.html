...
<div class="header high">
    ...
    <h2>
        ...
        Lines: <span class="metric">91.43% <small>(32 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  getDays() {</span>
<span class="cstat-no" title="statement not covered" >    return this.getHours() / 24;</span>
  }
&nbsp;
