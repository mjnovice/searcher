...
&nbsp;
  static emailAddressesToHyperlinks(
    ...
    me?: string,
    <span class="missing-if-branch" title="if path not taken" >I</span>lengthLimit = 2,
    <span class="missing-if-branch" title="if path not taken" >I</span>truncateName = false
  ): string {
