...
<div class="header medium">
    ...
    <h2>
        Statements: <span class="metric">76.4% <small>(136 / 178)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">78% <small>(78 / 100)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">64.71% <small>(22 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">77.65% <small>(132 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
    const currentPort = window.location.port != '' ? window.location.port : <span class="branch-1 cbranch-no" title="branch not covered" >window.location.protocol == 'https:' ? '443' : '80';</span>
...
&nbsp;
   ...
   * @returns {Promise&lt;T&gt;|Promise}
   */
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public callUsingXDomainRequest&lt;T&gt;(requestInfo: IRequestInfo&lt;T&gt;)</span>: Promise&lt;ISuccessResponse&lt;T&gt;&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >      let queryString = requestInfo.queryString.concat([]);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        queryString.push('access_token=' + Utils.safeEncodeURIComponent(this.options.accessToken));</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      const xDomainRequest = new XDomainRequest();</span>
<span class="cstat-no" title="statement not covered" >      if (requestInfo.method == 'GET') {</span>
<span class="cstat-no" title="statement not covered" >        queryString = queryString.concat(EndpointCaller.convertJsonToQueryString(requestInfo.requestData));</span>
      }
...
<span class="cstat-no" title="statement not covered" >        const data = this.tryParseResponseText(xDomainRequest.responseText, xDomainRequest.contentType);</span>
...
<span class="cstat-no" title="statement not covered" >          xDomainRequest.send(EndpointCaller.convertJsonToFormBody(requestInfo.requestData));</span>
        }
      });
    });
  }
&nbsp;
   ...
   * @returns {Promise&lt;T&gt;|Promise}
   */
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >  public callUsingAjaxJsonP&lt;T&gt;(requestInfo: IRequestInfo&lt;T&gt;)</span>: Promise&lt;ISuccessResponse&lt;T&gt;&gt; {</span>
...
<span class="cstat-no" title="statement not covered" >    return new Promise(<span class="fstat-no" title="function not covered" >(resolve, reject)</span> =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const queryString = requestInfo.queryString.concat(EndpointCaller.convertJsonToQueryString(requestInfo.requestData));</span>
&nbsp;
